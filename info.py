...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002264326677 -1002239734551 -1002189644835 -1002432923495 -1002607953782').split()]  # For Multiple Id Use One Space Between Each.
